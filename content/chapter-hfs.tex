...
\InsertFigure[fig:hfs:h-arch]{hfs/h-arch}{参考VHF的架构图}
...
\InsertFigure[fig:hfs:hdfs]{hfs/hdfs}{参考VHF的架构图}
...
\InsertFigure[fig:hfs:al]{hfs/h-class}{{\HFS}的主要继承关系}
...
\InsertFigure{hfs/seq-trash}{Trash机制序列图}
