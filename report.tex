...
\lstset{
	numbers=left,          % 左侧显示行号
	tabsize=2,             % tab = 4 space
	frame=lines,           % 水平线分割代码区域
	breaklines=true,       % 说来下面四个选项是干嘛来着
	extendedchars=false,
	showstringspaces=true,
	texcl=true
}
\lstdefinestyle{javaSuck}{
	language=Java,
...
\input{content/chapter-hfs-intro}
\input{content/chapter-hfs}
\input{content/chapter-env}
%\input{content/chapter-transplant}
%\input{content/chapter-src}
\cleardoublepage
